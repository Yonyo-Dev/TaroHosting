...
# 1. Instalamos herramientas base y PHP 8.3
...
# 2. Instalamos PHP 8.2 (Desde v3.19)
...
# 3. COMPATIBILIDAD PHP 8.1: Instalamos OpenSSL 1.1 y PHP 8.1 desde v3.16
# Aquí instalamos openssl-1.1-compat directamente del repo v3.16 para que no falle el enlace
RUN apk add --no-cache --repository=http://dl-cdn.alpinelinux.org/alpine/v3.16/main openssl-1.1-compat
...
# 5. Configuración de usuario para Pterodactyl
